...
const AuthForm = ({type}:{type:string}) => {
 ...
 const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
        //signup with Appwrite & create paid token
  ...
  return (
    <section className='auth-form'>
        <header className='flex flex-col gap-5 md:gap-8'>
            <Link href="/"
                className='cursor-pointor flex items-center gap-1'>
                    <Image
                        src="/icons/logo.svg"
                        width={34}
                        height={34}
                    ...
                    {type==='sign-up' &&(
                        <>
                            <div className="flex gap-4">
                                <CustomInput control={form.control} name="firstName" label="First Name" placeholder="ex: Jhon"/>
                            ...
                            <div className="flex gap-4">
                                ...
                                <CustomInput  control={form.control} name="postalCode" label="Postal Code" placeholder="ex: 1000" />
                            </div>
                            <div className="flex gap-4">
